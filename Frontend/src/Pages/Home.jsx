        ...
        <div className="flex justify-center items-center mt-6">
          <div className="relative w-full max-w-lg">
            ...
            <button className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-blue-600 p-2 rounded-full hover:bg-blue-700">
              <img src="/Images/search.png" alt="Search" className="w-4 h-4 cursor-pointer" />
            </button>
          </div>
        </div>
          ...
          {/* Upload Button */}
          <p className="mt-4 text-xl [text-shadow:_0_6px_6px_rgb(0_0_0_/1)]">If you want to upload study material</p>
